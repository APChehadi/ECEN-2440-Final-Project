...
void config_rtc(void) {
    ...
    RTC_C -> DATE = (0x07 << RTC_C_DATE_MON_OFS) |    // Month = 0x07 = November
           (0x29 | RTC_C_DATE_DAY_OFS);             // Day = 0x29 = 29th
    RTC_C -> TIM1 = (0x05 << RTC_C_TIM1_DOW_OFS) |   // Day of week = 0x05 = Friday
           (0x04 << RTC_C_TIM1_HOUR_OFS);           // Hour = 0x04
    RTC_C -> TIM0 = (0x44 << RTC_C_TIM0_MIN_OFS) |   // Minute = 0x42
